...
import com.juanpa.nebula.compiler.ast.expressions.Expression; // For the qualified name
import com.juanpa.nebula.compiler.lexer.Token; // For the 'import' token or modifiers
