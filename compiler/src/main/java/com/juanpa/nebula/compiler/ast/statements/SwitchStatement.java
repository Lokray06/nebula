...
import com.juanpa.nebula.compiler.ast.expressions.Expression; // The expression being switched on
import com.juanpa.nebula.compiler.lexer.Token; // Import Token
